...
public class TranServiceImpl implements TranService {
    ...
    public void saveCreateTran(Map<String, Object> map) {
        ...
        tranHistory.setTranId(tran.getId());    //见名知意，这里应直接传刚刚交易的id
        tranHistory.setCreateBy(user.getId());
        tranHistory.setCreateTime(DateUtil.formatDateTime19(new Date()));
    ...
    @Override
    public List<FunnelIVO> queryCountOfTranGroupByStage() {
