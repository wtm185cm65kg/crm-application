...
<script type="text/javascript">
	...
	$(function(){
		...
		/*将'工作台'作为登陆成功的初始窗口
		在name为workareaFrame的窗口(工作区窗口)，通过workbench/main/index.do请求转发到打开workbench/main/index.jsp页面*/
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<%--
					将main/index.jsp换为workbench/main/index.do，
					否则点击别的导航后再点回来会报404，因为main/index.jsp受保护，不能直接访问.
					如果换为workbench/main/index.do，则每次通过请求转发跳转，可访问保护资源(虽然会牺牲效率)
			    --%>
				...
				<%--将直接访问资源改为通过Controller跳转，原理同'工作台'--%>
